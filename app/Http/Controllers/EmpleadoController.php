...
class EmpleadoController extends Controller
{
    ...
    public function enviar_correo($id_empleado)
    {
        ...
        $correos_users_10 = 'jose.pazmino@movilidadmanta.gob.ec';
        $correos_users_11 = 'elizabeth.godoy@movilidadmanta.gob.ec';
        $correos_users_12 = 'george.leon@movilidadmanta.gob.ec';
        ...
        $em = Mail::send(
            ...
            function ($msj) use ($correos_users_1, $correos_users_2, $correos_users_3, $correos_users_4, $correos_users_5, $correos_users_6, $correos_users_7, $correos_users_8, $correos_users_9, $correos_users_10, $correos_users_11, $correos_users_12, $user_logueado) {
    ...
    public function get_empleados_search($limit, $text)
    {
        ...
        $sql = DB::connection('pgsql')->select("select emp_id, emp_cedula, emp_nombre, emp_apellido, emp_telefono, emp_direccion, emp_ruta_foto, emp_sexo, emp_cargo, emp_fecha_nacimiento, emp_tipo_sangre, dep_departamento, ca_cargo, emp_edad  from view_empleados_t WHERE upper(concat(emp_cedula, ' ', emp_apellido, ' ', emp_nombre)) like E'%" . strtoupper($text) . "%' AND emp_estado = 'A' LIMIT $limit");

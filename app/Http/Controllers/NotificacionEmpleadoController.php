...
class NotificacionEmpleadoController extends Controller
{
    ...
    public function enviar_correo($id_empleado, $fecha_salida)
    {
        ...
        $em = Mail::send(
            ...
            function ($msj) use ($correos_users_1 ,$correos_users_2, $correos_users_3, $correos_users_4, $correos_users_5, $correos_users_7, $correos_users_8, $correos_users_9, $correos_users_10, $correos_users_6, $correos_users_11, $correos_users_12, $user_logueado) {

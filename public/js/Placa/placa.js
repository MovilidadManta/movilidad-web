        ...
        success: function (response) {
            ...
            if (response.body === '{}') {
                ...
                $(response.data).each(function (i, data) {
                    ...
                    ht += '<h1 class="placa">' + data.placaActual + '</h1>';
                    ...
                    ht += '     <a class="btn background-btn-nuevo pad-nu" id="btn-consultar-p" onclick="imprimir_placa_provisional(\'' + data.placaActual + '\', \'' + response.id + '\')"'
                    ht += '          target="_blank">'
